...
Please read these guidelines before contributing to meziantou/prebuilt:
...
If you have questions about how to use meziantou/prebuilt, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/prebuilt's existing code formatting and naming standard
- Run meziantou/prebuilt's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/prebuilt you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
